...
if __name__ == '__main__':
    ...
    pages_soup = BeautifulSoup(pictures_page.content, 'html.parser')
    try:
        pages = int(pages_soup.find('div', class_='pagination-view').find_all('span')[-2].text)
    except IndexError:
        pages = 1
    ...
    for page in range(1, pages + 1):
        print('\r\n==> Processing album - page {}'.format(page))
        needs_paging = True
        previous_img_ref = 0
        while needs_paging:
        ...
        pictures_page = requests.get('{}/page{}'.format(album_url, page + 1))
